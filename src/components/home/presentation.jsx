    ...
    return (
        <section>
            <div className="w-full flex flex-col items-center justify-center md:flex-row md:justify-between gap-4">
                ...
                <p className="text-4xl sm:text-5xl text-center md:text-start max-w-[625px] w-full">I'm <span className="text-[#5b7493] font-black">teste</span>. I'm a Front-end developer.</p>
            </div>
