        ...
        <header className="w-full">
            <nav className="relative w-full flex py-4 navbar navbar-expand-md">
                <div className="container-fluid w-full flex flex-wrap items-center justify-end">
                    ...
                    <div className="collapse navbar-collapse flex-grow items-center bg-gray-100 max-md:absolute max-md:top-12 max-md:left-[50%] max-md:translate-x-[-50%] w-[60%] p-2 md:bg-inherit shadow-lg md:shadow-inherit rounded-xl" id="headerNavBar">
